...
const examples = [
    {
      ...
      description: 'Gain a full understanding of customer behaviors...',
    },
    {
      icon: logoIcon2,
      title: 'Data Synchronization',
      description: 'Effortlessly unify data from multiple sources...',
    },
    {
      icon: logoIcon3,
      title: 'Actionable Insights',
      description: 'Identify key metrics like LTV and ARPU...',
    },
    {
      icon: logoIcon4,
      title: 'Improved Targeting',
      description: 'Use detailed customer profiles to enhance...',
    },
  ];
